...
# This script takes an input directory and store all the JSON files there without
# doing a ASCII-safe conversion, and store directly the UTF-8 value in it.
...
arg_parser.add_argument("-i", "--input_dir", dest="input_dir", required=True,
                        help="The directory containing JSON files to convert.")
